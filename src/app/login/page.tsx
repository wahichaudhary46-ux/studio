          ...
          <div className="relative p-8">
            ...
            <div className="text-center mt-6">
              <button
                ...
                className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors duration-200 font-mono tracking-wide"
              >
                Forgot Password? <span className="text-blue-400 underline decoration-dotted">Click to reset</span>
              </button>
            </div>
